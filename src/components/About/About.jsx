...
const About = () => {
  return (
    <div    id="About" className="px-4 md:px-20 lg:px-40 py-12 md:py-24">
      ...
      {/* Groom Section */}
      <div data-aos="fade-right" className="flex flex-wrap  md:flex-nowrap h-auto mb-12 lg:mb-0 ">
        <div className="w-full md:w-1/2 p-6 md:p-10 text-center md:text-right bg-sky-100 flex flex-col justify-center">
          <h1 className="font-medium text-2xl sm:text-3xl md:text-4xl pb-4">
            The Groom
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-400">
            Let’s welcome our dashing groom, Arun, a kind-hearted and joyful
            person who brings positivity and warmth wherever he goes. Today, he
            takes a beautiful step forward, ready to embrace the journey of love
            and togetherness with his soulmate.
          </p>
      ...
      {/* Bride Section */}
      <div data-aos="fade-left" className="flex flex-wrap md:flex-nowrap h-auto">
        <div className="w-full md:w-1/2">
          <img
            className="h-full sm:h-64 md:h-auto w-full object-cover"
            src="./sowmi.png"
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 text-center md:text-left bg-sky-100 flex flex-col justify-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400">
            Now, let’s meet our stunning bride, Sowmi, a graceful and caring
            individual who lights up every room with her presence. With her
            gentle nature and radiant smile, she is all set to begin this new
            chapter filled with love and happiness.
          </p>
